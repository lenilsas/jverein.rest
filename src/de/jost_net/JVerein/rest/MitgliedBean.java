...
public class MitgliedBean implements AutoRestBean
{
   ...
   * @throws Exception
   */
  @Doc(value = "Liste der offenen Zusatzbeitröge eines Mitglied. ", example = "jverein/mitglied/123/zusatzbeitrag/open")
  ...
  @Doc(value = "Einem Mitglied einen Zusatzbeitrag zuweisen.\n"
      ...
      + "  <li><b>zahlungsweg</b>: optional: Zahlungsweg (0: default, 1: Lastschrift, 2: Überweisung, 3: Bar)</li>\n"
